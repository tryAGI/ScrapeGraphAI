...
{
    /// <inheritdoc />
    public sealed class AgenticScrapperStatusJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::ScrapeGraphAI.AgenticScrapperStatus>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::ScrapeGraphAI.AgenticScrapperStatusExtensions.ToValueString(value));
        }
    }
}
