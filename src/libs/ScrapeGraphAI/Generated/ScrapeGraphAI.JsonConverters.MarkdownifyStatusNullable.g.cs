...
{
    /// <inheritdoc />
    public sealed class MarkdownifyStatusNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::ScrapeGraphAI.MarkdownifyStatus?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::ScrapeGraphAI.MarkdownifyStatusExtensions.ToValueString(value.Value));
            }
        }
    }
}
