...
{
    /// <inheritdoc />
    public sealed class CrawlStatusNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::ScrapeGraphAI.CrawlStatus?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::ScrapeGraphAI.CrawlStatusExtensions.ToValueString(value.Value));
            }
        }
    }
}
