...
namespace ScrapeGraphAI
{
    public partial class AgenticScrapperClient
    {
        ...
        {
            var __response = await AgenticScrapperV1AgenticScrapperPostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::ScrapeGraphAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::ScrapeGraphAI.AutoSDKHttpResponse<global::ScrapeGraphAI.AgenticScrapperResponse>> AgenticScrapperV1AgenticScrapperPostAsResponseAsync(
                    ...
                    await global::ScrapeGraphAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::ScrapeGraphAI.AgenticScrapperResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::ScrapeGraphAI.AutoSDKHttpResponse<global::ScrapeGraphAI.AgenticScrapperResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::ScrapeGraphAI.AgenticScrapperResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
