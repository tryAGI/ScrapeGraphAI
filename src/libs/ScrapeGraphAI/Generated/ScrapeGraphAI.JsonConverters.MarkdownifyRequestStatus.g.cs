...
{
    /// <inheritdoc />
    public sealed class MarkdownifyRequestStatusJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::ScrapeGraphAI.MarkdownifyRequestStatus>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::ScrapeGraphAI.MarkdownifyRequestStatusExtensions.ToValueString(value));
        }
    }
}
