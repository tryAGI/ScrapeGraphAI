...
{
    /// <inheritdoc />
    public class AnyOfJsonConverter<T1, T2, T3, T4, T5, T6, T7, T8> : global::System.Text.Json.Serialization.JsonConverter<global::ScrapeGraphAI.AnyOf<T1, T2, T3, T4, T5, T6, T7, T8>>
    {
        /// <inheritdoc />
        public override global::ScrapeGraphAI.AnyOf<T1, T2, T3, T4, T5, T6, T7, T8> Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var __value = new global::ScrapeGraphAI.AnyOf<T1, T2, T3, T4, T5, T6, T7, T8>(
                value1,
        ...
        public override void Write(
            ...
            global::ScrapeGraphAI.AnyOf<T1, T2, T3, T4, T5, T6, T7, T8> value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
