...
{
    /// <inheritdoc />
    public sealed class ScrapeStatusJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::ScrapeGraphAI.ScrapeStatus>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::ScrapeGraphAI.ScrapeStatusExtensions.ToValueString(value));
        }
    }
}
