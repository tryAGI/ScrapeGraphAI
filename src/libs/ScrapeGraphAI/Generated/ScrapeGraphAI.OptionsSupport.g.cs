...
namespace ScrapeGraphAI
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::ScrapeGraphAI.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::ScrapeGraphAI.IAutoSDKHook>();
        ...
        /// </summary>
        public global::ScrapeGraphAI.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::ScrapeGraphAI.AutoSDKClientOptions UseAuthorizationProvider(
            global::ScrapeGraphAI.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::ScrapeGraphAI.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::ScrapeGraphAI.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::ScrapeGraphAI.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::ScrapeGraphAI.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::ScrapeGraphAI.AutoSDKAuthorizationValue>?> ResolveAsync(
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::ScrapeGraphAI.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::ScrapeGraphAI.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::ScrapeGraphAI.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::ScrapeGraphAI.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::ScrapeGraphAI.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    internal static class AutoSDKRequestOptionsSupport
    {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::ScrapeGraphAI.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::ScrapeGraphAI.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::ScrapeGraphAI.AutoSDKClientOptions clientOptions,
            global::System.Func<global::ScrapeGraphAI.IAutoSDKHook, global::ScrapeGraphAI.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::ScrapeGraphAI.AutoSDKHookContext context)
        {
