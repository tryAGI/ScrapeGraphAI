...
namespace ScrapeGraphAI
{
    ...
    [global::System.Text.Json.Serialization.JsonSerializable(typeof(bool?))]
    [global::System.Text.Json.Serialization.JsonSerializable(typeof(int?))]
    [global::System.Text.Json.Serialization.JsonSerializable(typeof(global::ScrapeGraphAI.MarkdownifyStatus?), TypeInfoPropertyName = "NullableMarkdownifyStatus2")]
    ...
    internal sealed partial class MarkdownifySourceGenerationContextChunk0 : global::System.Text.Json.Serialization.JsonSerializerContext
    {
    }
    /// <summary>
    ///
    /// </summary>
    public sealed partial class MarkdownifySourceGenerationContext : global::System.Text.Json.Serialization.JsonSerializerContext
    {
        ...
        ///
        /// </summary>
        public static MarkdownifySourceGenerationContext Default { get; } = new(DefaultOptions);

        private MarkdownifySourceGenerationContext(global::System.Text.Json.JsonSerializerOptions options)
            : base(options)
        {
        }
        ...
        private sealed class LazyEnumJsonConverterFactory : global::System.Text.Json.Serialization.JsonConverterFactory
        {
            ...
            {
                return
                    typeToConvert == typeof(global::ScrapeGraphAI.MarkdownifyStatus)
            ...
            {
                if (typeToConvert == typeof(global::ScrapeGraphAI.MarkdownifyStatus))
                {
                    return new global::ScrapeGraphAI.JsonConverters.MarkdownifyStatusJsonConverter();
                }

                if (typeToConvert == typeof(global::ScrapeGraphAI.MarkdownifyStatus?))
                {
                    return new global::ScrapeGraphAI.JsonConverters.MarkdownifyStatusNullableJsonConverter();
                }
        ...
        private sealed class LazyChunkResolver : global::System.Text.Json.Serialization.Metadata.IJsonTypeInfoResolver
        {
            ...
            private static global::System.Text.Json.Serialization.Metadata.IJsonTypeInfoResolver CreateResolver(int index)
            {
                return index switch
                {
                    0 => new MarkdownifySourceGenerationContextChunk0(new global::System.Text.Json.JsonSerializerOptions()),
